...
app.use((req, res, next) => {
  ...
  res.header(
    ...
    'Content-Range,X-Content-Range,Authorization,X-Total-Count',
  );
...
app.all(
  /^\/(token|user|mfa|factors|verify|otp|recover|signup|logout|authorize|callback|admin|settings)/,
  (req, res) => {
...
app.get('/platform/organizations/:slug/roles', (req, res) =>
  res.json({
    org_scoped_roles: [{ id: 1, name: 'Owner', description: null, base_role_id: 1, projects: [] }],
...
app.get('/platform/organizations/:slug/billing/plans', (req, res) =>
  res.json([{ id: 'free', name: 'Free' }]),
);
app.get('/platform/organizations/:slug/billing/credits/balance', (req, res) =>
  res.json({ balance: 0 }),
);
app.get('/platform/organizations/:slug/entitlements', (req, res) => res.json({ entitlements: [] }));
app.get('/platform/organizations/:slug/usage', (req, res) =>
  res.json({ usage_billing_enabled: false, usages: [] }),
);
...
app.get('/platform/organizations/:slug/members/mfa/enforcement', (req, res) =>
  res.json({ required: false }),
);
app.get('/platform/organizations/:slug/members/invitations/:token', (req, res) =>
...
app.get('/platform/projects/:ref/api/rest', (req, res) => {
  res.json({
    endpoint: `http://148.113.1.164:8000/rest/v1`,
    schema: 'public',
...
app.get('/platform/projects/:ref/config/pgbouncer/status', (req, res) =>
  res.json({ active: true }),
);
app.get('/platform/projects/:ref/config/secrets/update-status', (req, res) =>
...
app.get('/platform/projects/:ref/analytics/endpoints/service-health', (req, res) =>
  res.json({ services: [] }),
);
...
app.get('/platform/projects/:ref/notifications/advisor/exceptions', (req, res) =>
  res.json({ result: [] }),
);
app.get('/platform/projects/:ref/pause/status', (req, res) =>
  res.json({ initiated_at: null, status: 'not_pausing' }),
);
...
app.get('/platform/projects/:ref/content/folders/:id', (req, res) =>
  res.json({ id: req.params.id }),
);
app.get('/platform/projects/:ref/content/item/:id', (req, res) =>
  res.status(404).json({ error: 'not found' }),
);
app.post('/platform/projects/:ref/content', (req, res) =>
  res.json({ ...req.body, id: Date.now() }),
);

app.get('/platform/projects/:ref/databases', (req, res) =>
  res.json([
    {
      ...
      region: 'local',
      restUrl: `http://148.113.1.164:8000`,
      size: 'micro',
...
app.get('/platform/projects/:ref/privatelink/associations', (req, res) =>
...
app.post('/v1/projects/:ref/network-bans/retrieve', (req, res) =>
  res.json({ banned_ipv4_addresses: [] }),
);
app.delete('/v1/projects/:ref/network-bans', (req, res) => res.sendStatus(204));
app.get('/v1/projects/:ref/network-restrictions', (req, res) =>
  res.json({
...
app.get('/v1/projects/:ref/custom-hostname', (req, res) =>
  res.json({ status: 'not_started', customHostname: null, data: {} }),
);
app.get('/v1/projects/:ref/upgrade/eligibility', (req, res) =>
  res.json({ eligible: false, current_app_version: 'supabase-postgres-15.0.0.55' }),
);
...
app.get('/v1/projects/:ref/health', (req, res) => {
  const services = req.query.services
    ? String(req.query.services).split(',')
...
// Disk
app.get('/platform/projects/:ref/disk', (req, res) =>
  res.json({ size_gb: 8, type: 'gp3', iops: 3000, throughput_mbps: 125 }),
);
app.get('/platform/projects/:ref/disk/util', (req, res) =>
  res.json({ usage_bytes: 0, total_bytes: 8589934592 }),
);
...
app.get('/v1/projects/:ref/api-keys', (req, res) =>
  res.json([
...
app.post('/platform/auth/:ref/users', (req, res) =>
  res.json({ id: 'mock-user-id', email: req.body?.email }),
);
...
app.post('/platform/auth/:ref/invite', (req, res) =>
  res.json({ id: 'mock', email: req.body?.email }),
);
...
app.get('/platform/projects/:ref/config/realtime', (req, res) =>
  res.json({ max_concurrent_users: 200 }),
);
...
app.get('/platform/projects/:ref/api-keys/temporary', (req, res) =>
  res.json({ anon_key: process.env.ANON_KEY || '', service_role_key: SERVICE_KEY || '' }),
);
app.get('/platform/projects/:ref/analytics/endpoints/auth.metrics', (req, res) =>
  res.json({ result: [] }),
);
app.get('/platform/projects/:ref/analytics/endpoints/functions.combined-stats', (req, res) =>
  res.json({ result: [] }),
);
app.get('/platform/projects/:ref/analytics/endpoints/functions.req-stats', (req, res) =>
  res.json({ result: [] }),
);
app.get('/platform/projects/:ref/analytics/endpoints/functions.resource-usage', (req, res) =>
  res.json({ result: [] }),
);
app.get('/platform/projects/:ref/analytics/endpoints/logs.all', (req, res) =>
  res.json({ result: [], count: 0 }),
);
app.get('/platform/projects/:ref/analytics/endpoints/logs.all.otel', (req, res) =>
  res.json({ result: [] }),
);
app.get('/platform/projects/:ref/analytics/endpoints/usage.api-counts', (req, res) =>
  res.json({ result: [] }),
);
app.get('/platform/projects/:ref/analytics/endpoints/usage.api-requests-count', (req, res) =>
  res.json({ result: [] }),
);
app.get('/platform/projects/:ref/analytics/log-drains', (req, res) => res.json([]));
app.post('/platform/projects/:ref/analytics/log-drains', (req, res) =>
  res.json({ token: 'mock', ...req.body }),
);
app.put('/platform/projects/:ref/analytics/log-drains/:token', (req, res) => res.json(req.body));
app.delete('/platform/projects/:ref/analytics/log-drains/:token', (req, res) =>
  res.sendStatus(204),
);
app.post('/platform/projects/:ref/privatelink/associations/aws-account', (req, res) =>
  res.json({}),
);
app.get('/platform/projects/:ref/privatelink/associations/aws-account/:id', (req, res) =>
  res.json({}),
);

// Database backups
app.get('/platform/database/:ref/backups', (req, res) =>
  res.json({ backups: [], tierId: 'free', tierKey: 'FREE' }),
);
app.get('/platform/database/:ref/backups/downloadable-backups', (req, res) =>
  res.json({ backups: [] }),
);
app.post('/platform/database/:ref/backups/download', (req, res) => res.json({ url: null }));
app.post('/platform/database/:ref/backups/restore', (req, res) =>
  res.json({ status: 'restoring' }),
);
app.post('/platform/database/:ref/backups/restore-physical', (req, res) =>
  res.json({ status: 'restoring' }),
);
app.post('/platform/database/:ref/backups/pitr', (req, res) => res.json({ status: 'restoring' }));
app.post('/platform/database/:ref/backups/enable-physical-backups', (req, res) =>
  res.sendStatus(200),
);
...
app.get('/platform/organizations/:slug/members/reached-free-project-limit', (req, res) =>
  res.json({ reached_free_project_limit: false }),
);
...
app.delete('/platform/organizations/:slug/members/invitations/:id', (req, res) =>
  res.sendStatus(204),
);
...
app.post('/platform/organizations/:slug/members/:gotrue_id/roles/:role_id', (req, res) =>
  res.sendStatus(200),
);
app.delete('/platform/organizations/:slug/members/:gotrue_id/roles/:role_id', (req, res) =>
  res.sendStatus(204),
);
...
app.post('/platform/organizations/:slug/billing/upgrade-request', (req, res) =>
  res.sendStatus(200),
);
app.post('/platform/organizations/:slug/payments/setup-intent', (req, res) =>
  res.json({ client_secret: null }),
);
...
app.post('/platform/organizations/:slug/apps/:app_id/signing-keys', (req, res) =>
  res.json({ id: 'mock' }),
);
app.delete('/platform/organizations/:slug/apps/:app_id/signing-keys/:key_id', (req, res) =>
  res.sendStatus(204),
);
app.post('/platform/organizations/:slug/apps/installations', (req, res) => res.json({}));
app.delete('/platform/organizations/:slug/apps/installations/:id', (req, res) =>
  res.sendStatus(204),
);
...
app.post('/platform/organizations/:slug/oauth/apps/:id/client-secrets', (req, res) =>
  res.json({ secret: 'mock' }),
);
app.delete('/platform/organizations/:slug/oauth/apps/:id/client-secrets/:sid', (req, res) =>
  res.sendStatus(204),
);
app.get('/platform/oauth/authorizations/:id', (req, res) => res.json({}));
app.patch('/platform/organizations/:slug/members/mfa/enforcement', (req, res) =>
  res.json(req.body),
);
...
app.post('/platform/storage/:ref/buckets/:id/objects/sign', (req, res) =>
  res.json({ signedURL: null }),
);
app.post('/platform/storage/:ref/buckets/:id/objects/sign-multi', (req, res) => res.json([]));
app.post('/platform/storage/:ref/buckets/:id/objects/public-url', (req, res) =>
...
app.delete('/platform/storage/:ref/vector-buckets/:id/indexes/:name', (req, res) =>
  res.sendStatus(204),
);
...
app.delete('/platform/replication/:ref/sources/:source_id/publications/:name', (req, res) =>
  res.sendStatus(204),
);
app.post('/platform/replication/:ref/destinations-pipelines', (req, res) => res.json({}));
app.delete('/platform/replication/:ref/destinations-pipelines/:did/:pid', (req, res) =>
  res.sendStatus(204),
);
app.post('/platform/replication/:ref/destinations/validate', (req, res) =>
  res.json({ valid: true }),
);
...
app.get('/platform/replication/:ref/pipelines/:id/status', (req, res) =>
  res.json({ status: 'stopped' }),
);
app.get('/platform/replication/:ref/pipelines/:id/version', (req, res) =>
...
app.get('/debug/unhandled', (req, res) => {
  const sorted = Object.entries(unhandledRoutes)
    .sort((a, b) => b[1] - a[1])
