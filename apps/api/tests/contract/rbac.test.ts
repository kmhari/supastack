  ...
  test('snapshot of permission matrix (regression watchdog)', () => {
    ...
    expect(rows).toMatchInlineSnapshot(`
      [
        ...
        "administrator	credential.mint-data-plane-key	ALLOW",
        ...
        "developer	credential.mint-data-plane-key	ALLOW",
        ...
        "owner	credential.mint-data-plane-key	ALLOW",
        ...
        "read_only	credential.mint-data-plane-key	ALLOW",
