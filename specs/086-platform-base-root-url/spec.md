...
- Out of scope (filed as follow-ups): making the platform backup/restore + audit routes real (they are stubs today); broader removal of redundant façade copies beyond the two named.
