...
| `pre_restore_dir` | text | NULL | Filesystem path to the rollback snapshot, e.g. `/var/selfbase/instances/<ref>/volumes/db/data.pre-restore-<id>`. Set when running, cleared after GC. |
