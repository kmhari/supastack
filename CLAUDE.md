...
<!-- SPECKIT START -->
**Active feature plan**: none currently in flight. Feature 012 just landed — see "What's shipped" row above.

**Most recently merged**: feature 012 — CLI login-role for passwordless `supabase db push` (closes issue #31). Implementation complete on branch `012-cli-login-role`; see [docs/changes/012-cli-login-role.md](docs/changes/012-cli-login-role.md) and [specs/012-cli-login-role/plan.md](specs/012-cli-login-role/plan.md).
